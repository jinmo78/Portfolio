...
- 스파르타클럽 수료증 2장 추가: AI 서비스 엔지니어링 트랙 9기, 데이터 분석 파이썬 종합반
...
- 출시 앱 기준으로 Python, Fastify, Socket.io, SQLite, OpenAI 배지 추가
- 웹·모바일·백엔드·AI·게임 순으로 배지 재배치
...
- 개인 프로젝트·회사 경력 모바일 기본 표시 **3개**로 통일
- 각 섹션 **더 보기** 버튼으로 나머지 항목 펼침
- 경력 섹션 모바일/데스크톱 설명 문구 분리
...
- `ProjectCarousel.jsx` — 모바일 3개+더보기, 데스크톱 6개 슬라이드 캐러셀
